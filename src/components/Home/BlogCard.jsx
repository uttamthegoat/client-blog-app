...
const BlogCard = ({ blog }) => {
  return (
    <div className="Blog_card border-4 border-sky-300 shadow-xl px-3 py-2 w-full sm:w-11/12 rounded-lg mx-auto bg-gradient-to-r from-blue-400 to-sky-500">
      {/* card */}
      ...
      <p className="text-md mb-3 font-semibold text-gray-700">
